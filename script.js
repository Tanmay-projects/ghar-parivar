...
/* Homepage quote and family-member login panel. Inserted AFTER the two home blocks. */
(function addHomeWelcome(){
 ...
 wrap.innerHTML=`<section class="family-welcome-quote" aria-label="परिवार संदेश" style="max-width:1100px;margin:26px auto 26px;padding:34px 28px 30px;text-align:center;background:linear-gradient(135deg,#fffaf1,#fff);border:1px solid #ead7b6;border-radius:22px;box-shadow:0 14px 35px rgba(93,53,20,.09);position:relative;overflow:hidden"><div style="position:absolute;inset:0;background:radial-gradient(circle at 15% 20%,rgba(217,165,47,.13),transparent 30%),radial-gradient(circle at 85% 80%,rgba(138,24,32,.08),transparent 32%);pointer-events:none"></div><div style="position:relative;z-index:1"><div style="font-size:42px;line-height:.7;color:#d9a52f;font-family:Georgia,serif">❝</div><div style="font-size:12px;font-weight:800;letter-spacing:2px;color:#8a1820;margin:8px 0 10px">हमारा परिवार</div><blockquote style="margin:0 auto;color:#4a1b1d;font-family:Georgia,'Noto Sans Devanagari',serif;font-size:24px;line-height:1.7;font-weight:600;max-width:850px">परिवार ही सब कुछ हे...<br>हिम्मत हे, होसला हे, सम्बल है, ताक़त हे,<br>ओर हर आपदा को जितने का विश्वास हे.</blockquote><div style="margin-top:14px;color:#d9a52f;font-size:14px;letter-spacing:4px">✦ ───────── ✦</div></div></section><section class="family-member-login" aria-label="परिवार के सदस्य लॉगिन" style="max-width:1100px;margin:0 auto 30px;padding:22px 26px;display:flex;align-items:center;gap:20px;border-radius:18px;background:linear-gradient(110deg,#2b0708,#5b1015,#2b0708);border:1px solid #d9a52f;box-shadow:0 12px 30px rgba(43,7,8,.16);color:#fff"><div style="width:58px;height:58px;flex:0 0 58px;border-radius:50%;display:grid;place-items:center;background:#d9a52f;color:#2b0708;font-size:28px;box-shadow:0 5px 15px rgba(217,165,47,.25)">♙</div><div class="member-login-copy" style="flex:1"><span style="display:block;font-size:11px;font-weight:800;letter-spacing:1.5px;color:#f0c967">FAMILY MEMBERS • परिवार के सदस्य</span><h2 style="margin:4px 0 4px;font-family:Georgia,'Noto Sans Devanagari',serif;font-size:24px;color:#fff">परिवार के सदस्य</h2><p style="margin:0;color:#ead9d0;font-size:13px;line-height:1.5">अधिकृत सदस्य अपनी निजी पारिवारिक जानकारी सुरक्षित रूप से देख सकते हैं।</p></div><button class="member-login-btn" data-page="login" style="border:1px solid #f1cc67;border-radius:10px;background:#d9a52f;color:#2b0708;padding:12px 20px;font-weight:900;white-space:nowrap;cursor:pointer;box-shadow:0 5px 14px rgba(0,0,0,.18)">🔐 सदस्य लॉगिन</button></section>`;
 blocks.parentNode.insertBefore(wrap,blocks.nextSibling);
})();
